...
public struct CreatePostWithFileInput: GraphQLMapConvertible {
  ...
  public init(id: GraphQLID, author: String, title: Optional<String?> = nil, content: Optional<String?> = nil, url: Optional<String?> = nil, ups: Optional<Int?> = nil, downs: Optional<Int?> = nil, file: S3ObjectInput, version: Int) {
    graphQLMap = ["id": id, "author": author, "title": title, "content": content, "url": url, "ups": ups, "downs": downs, "file": file, "version": version]
  }
...
public final class AddPostWithFileMutation: GraphQLMutation {
  public static let operationString =
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static let selections: [GraphQLSelection] = [
      GraphQLField("createPostWithFile", arguments: ["input": GraphQLVariable("input")], type: .object(CreatePostWithFile.selections)),
    ]
    ...
    public init(createPostWithFile: CreatePostWithFile? = nil) {
      self.init(snapshot: ["__typename": "Mutation", "createPostWithFile": createPostWithFile.flatMap { $0.snapshot }])
    }

    public var createPostWithFile: CreatePostWithFile? {
      get {
        return (snapshot["createPostWithFile"] as? Snapshot).flatMap { CreatePostWithFile(snapshot: $0) }
      }
      set {
        snapshot.updateValue(newValue?.snapshot, forKey: "createPostWithFile")
      }
    }

    public struct CreatePostWithFile: GraphQLSelectionSet {
      public static let possibleTypes = ["Post"]
      ...
      public init(id: GraphQLID, title: String? = nil, author: String, url: String? = nil, content: String? = nil, ups: Int? = nil, downs: Int? = nil, version: Int, file: File? = nil) {
        self.init(snapshot: ["__typename": "Post", "id": id, "title": title, "author": author, "url": url, "content": content, "ups": ups, "downs": downs, "version": version, "file": file.flatMap { $0.snapshot }])
      }
